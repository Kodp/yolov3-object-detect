...
from nets.core import yolo_loss
from keras.backend.tensorflow_backend import set_session
from nets.utils import get_random_data
...
if __name__ == "__main__":
    ...
    # 获取classes和anchor的位置
    classes_path = 'model_data/hat.txt'    
   ...
   # 调整非主干模型first
    ...
    #model.load_weights("logs/ep354-loss12.050-val_loss12.699.h5")
